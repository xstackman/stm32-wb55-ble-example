...
#define CFG_HW_LPUART1_MODE                    UART_MODE_TX
...
#define CFG_HW_LPUART1_RX_PORT_CLK_ENABLE      __HAL_RCC_GPIOvalueNotSetted_CLK_ENABLE
#define CFG_HW_LPUART1_RX_PORT                 GPIOvalueNotSetted
#define CFG_HW_LPUART1_RX_PIN                  GPIO_PIN_valueNotSetted
...
#define CFG_HW_LPUART1_RX_ALTERNATE            GPIO_AFvalueNotSetted_LPUART1
